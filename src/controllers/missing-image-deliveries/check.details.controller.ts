...
const route = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (basket.enrolled) {
            ...
            logger.info(`User enrolled for multi-item basket. Item appended to basket missing_image_delivery_id=${missingImageDeliveryId}, user_id=${userId}, company_number=${resp.companyNumber}, redirecting to basket`);
        } else {
