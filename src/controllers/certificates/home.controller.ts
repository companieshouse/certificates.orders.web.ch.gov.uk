...
export default async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (companyStatus === "dissolved") {
            ...
            view = "certificates/dissolved-company-landing";
            ...
            view = "certificates/active-company-landing"
        ...
        if (allow && ["active", "dissolved"].includes(companyStatus)) {
            ...
            res.render(view, { companyStatus, startNowUrl, companyNumber, SERVICE_URL, DISPATCH_DAYS, moreTabUrl, companyName });
        } else {
