...
export const render = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        logger.debug(`LLP Certificate render function called, company_number=${companyNumber}`);
        ...
        if (companyStatus === "active") {
            ...
            res.redirect(replaceCertificateId(LLP_CERTIFICATE_OPTIONS, certificateItem.id));
        } else {
