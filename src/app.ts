...
const PROTECTED_PATHS = [
    ...
    pageUrls.CERTIFICATE_ADDITIONAL_COPIES_OPTIONS,
    pageUrls.CERTIFICATE_ADDITIONAL_COPIES_QUANTITY_OPTIONS,
    ...
    pageUrls.LP_CERTIFICATE_ADDITIONAL_COPIES_OPTIONS,
    pageUrls.LP_CERTIFICATE_ADDITIONAL_COPIES_QUANTITY_OPTIONS,
    ...
    pageUrls.LLP_CERTIFICATE_ADDITIONAL_COPIES_OPTIONS,
    pageUrls.LLP_CERTIFICATE_ADDITIONAL_COPIES_QUANTITY_OPTIONS,
    ...
    pageUrls.DISSOLVED_CERTIFICATE_ADDITIONAL_COPIES_OPTIONS,
    pageUrls.DISSOLVED_CERTIFICATE_ADDITIONAL_COPIES_QUANTITY_OPTIONS,
...
app.use(pageUrls.ROOT_CERTIFICATE, csrfProtectionMiddleware);
...
app.use(pageUrls.LP_ROOT_CERTIFICATE, csrfProtectionMiddleware);
...
app.use(pageUrls.LLP_ROOT_CERTIFICATE, csrfProtectionMiddleware);
...
app.use(pageUrls.ROOT_DISSOLVED_CERTIFICATE, csrfProtectionMiddleware);
