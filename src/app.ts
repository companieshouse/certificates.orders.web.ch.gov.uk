...
import {
    ...
    CHS_URL,
    LP_CERTIFICATE_PIWIK_START_GOAL_ID, LLP_CERTIFICATE_PIWIK_START_GOAL_ID, CERTIFICATE_FEEDBACK_SOURCE, LLP_CERTIFICATE_FEEDBACK_SOURCE, LP_CERTIFICATE_FEEDBACK_SOURCE, MISSING_IMAGE_DELIVERY_COPIES_FEEDBACK_SOURCE, CERTIFIED_COPIES_FEEDBACK_SOURCE, DISSOLVED_CERTIFICATE_FEEDBACK_SOURCE
} from "./config/config";
