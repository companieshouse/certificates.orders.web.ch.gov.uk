...
export const ORDER_DETAILS_COMPANY_NAME_MAX_LENGTH: string = "Company name must be 32 characters or fewer";
...
export const COMPANY_NAME_INVALID_CHARACTERS: string = "Company name cannot include ";
...
export const ADDITIONAL_COPIES_QUANTITY_OPTION_SELECTION: string = "Select how many additional copies you need";
